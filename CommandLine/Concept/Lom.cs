...
namespace VS.Library.Cache
{
		...
		where T : class
	{
		...
		/// <remarks>Make sure all temporary references to the LO instance 
		/// are dropped prior to calling this method.
		/// If not, the instance will not be automatically garbage collected.</remarks>
		/// </summary>
		public void Release()
		{
			if (this.counter == 0)
